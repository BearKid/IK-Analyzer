...
public class SWMCQueryBuilder {
     ...
     * @return Lucene Query
     */
    public Query create(String fieldName, String keywords, boolean quickMode) {
     ...
     * @return
     */
    private List<Lexeme> doAnalyze(String keywords) {
        List<Lexeme> lexemes = new ArrayList<Lexeme>();
        IKSegmenter ikSeg = new IKSegmenter(new StringReader(keywords), true, dictionary);
        try {
            Lexeme l = null;
